/*
Copyright (c) 2003-2009 Erwin Coumans  http://m_bullet.googlecode.com
...
/* SVN $Revision$ on $Date$ from http://m_bullet.googlecode.com*/
...
//			#pragma warning(disable:4786) // Disable the "debug name too long" warning
			...
			//it makes it harder to integrate BulletSprite into your application under Windows 
			//(structured embedding BulletSprite structs/classes need to be 16-byte aligned)
			//with relatively little performance gain
			//If you are not embedded BulletSprite data in your classes, or make sure that you align those classes on 16-byte boundaries
