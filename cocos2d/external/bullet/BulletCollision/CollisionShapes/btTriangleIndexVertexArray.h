...
ATTRIBUTE_ALIGNED16( struct)	btIndexedMesh
{
   ...
   // The vertex type has a default type similar to BulletSprite's precision mode (float or double)
   // but can be set manually if you for example run BulletSprite with double precision but have
