...
#if 0
///warning: this termination condition leads to some problems in 2d test case see BulletSprite/Demos/Box2dDemo
		...
		if (checkPenetration && (!isValid || catchDegeneratePenetrationCase ))
		{
			...
			if (m_penetrationDepthSolver)
			{
...

				{
					...
					///http://code.google.com/p/m_bullet/issues/detail?id=250
