...
///- C) Kinematic objects, which are objects without mass, but the user can move them. There is on-way interaction, and BulletSprite calculates a velocity based on the timestep and previous and current world transform.
///BulletSprite automatically deactivates dynamic rigid bodies, when the velocity is below a threshold for a given time.
...
public:
	...
	struct	btRigidBodyConstructionInfo
	{
		...
		///See BulletSprite/Demos/RollingFrictionDemo for usage
