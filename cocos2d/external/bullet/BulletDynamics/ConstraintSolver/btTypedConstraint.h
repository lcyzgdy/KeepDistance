...
Copyright (c) 2003-2010 Erwin Coumans  http://continuousphysics.com/BulletSprite/
...
///TypedConstraint is the baseclass for BulletSprite constraints and vehicles
...
///this structure is not used, except for loading pre-2.82 .m_bullet files
