...
bool AppDelegate::applicationDidFinishLaunching()
{
	...
	glview->setDesignResolutionSize(largeResolutionSize.width, largeResolutionSize.height, ResolutionPolicy::EXACT_FIT);
	...
	FileUtils::getInstance()->addSearchPath("Label");
	FileUtils::getInstance()->addSearchPath("Music");
	FileUtils::getInstance()->addSearchPath("Background");

	// create a scene. it's an varrelease object
	//var scene = HelloWorld::createScene();
	//var scene = AirPlaneScene::createScene();
	PhysicsWorld* world;
	//var scene = CastScene::createSceneWithPhysics();
	var scene = Welcome_Scene::create();
